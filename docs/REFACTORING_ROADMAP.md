...
| E-3. Testcontainers 통합 테스트 인프라 | ✅ | — | MySQL+Redis 컨테이너, 통합 테스트 6건 |
| E-4. 컨트롤러 슬라이스 테스트 | ✅ | — | @WebMvcTest 4건 (user 2, playlist 2), 12 테스트 케이스 |
...
| F-5. partyview ArchUnit 검증 범위 포함 | ✅ | — | 검증 범위 추가 완료 |
