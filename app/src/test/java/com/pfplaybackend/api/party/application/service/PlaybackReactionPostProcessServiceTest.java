...
class PlaybackReactionPostProcessServiceTest {
    ...
    @InjectMocks PlaybackReactionPostProcessService service;
    ...
    void postProcess_grabStatusChanged_callsGrabTrack() {
        ...
        when(playbackInfoService.getPlaybackById(playbackId)).thenReturn(playback);
    ...
    void postProcess_aggregationChanged_updatesAndPublishes() {
        ...
        when(playbackInfoService.updatePlaybackAggregation(playbackId.getId(), List.of(1, 0, 0)))
        ...
        // then
        verify(playbackInfoService).updatePlaybackAggregation(playbackId.getId(), List.of(1, 0, 0));
