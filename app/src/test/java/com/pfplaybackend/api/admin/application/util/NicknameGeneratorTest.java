...
class NicknameGeneratorTest {
    ...
    void generate_notNullAndNotEmpty() {
        // given & when
    ...
    void generate_pascalCaseFormat() {
        // given & when
        String nickname = NicknameGenerator.generate();
    ...
    void generateWithSuffix_containsSuffix() {
        // given
        int suffix = 123;
    ...
    void generateUnique_containsIndex() {
        // given
        int index = 1;
