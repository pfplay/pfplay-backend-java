...
import com.pfplaybackend.api.playlist.presentation.payload.request.*;
import com.pfplaybackend.api.playlist.application.service.PlaylistService;
...
public class PlaylistController {
    ...
    public ResponseEntity<?> create(@RequestBody @Valid PlaylistCreateRequest request) {
        ...
        Playlist playlist = playlistService.createPlaylist(request.getName(), userCredentials.getUserId());
