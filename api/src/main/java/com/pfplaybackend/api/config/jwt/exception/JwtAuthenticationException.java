...
public enum JwtAuthenticationException implements SecurityException {
    ...
    ACCESS_TOKEN_INVALID("JWT-001", "Json Web Token is not valid", UnauthorizedException.class),
    ACCESS_TOKEN_EXPIRED("JWT-002", "Json Web Token is expired", UnauthorizedException.class);
