...
public class CrewPenaltyController {
    ...
    public ResponseEntity<?> getAllPenalties(@PathVariable("partyroomId") Long id) {
    ...
    public ResponseEntity<?> imposeCrewPenalty(@PathVariable("partyroomId") Long partyroomId,
                                  @Valid @RequestBody PunishPenaltyRequest request) {
        // TODO targetCrewId 정보를 요청 본문으로 이동
        crewPenaltyService.addPenalty(new PartyroomId(partyroomId), request);
    ...
    public ResponseEntity<?> releaseCrewPenalty(@PathVariable("partyroomId") Long partyroomId,
