...
class SearchMusicListRequestTest {
    ...
    void shouldPassValidation_whenPlatformIsNull() {
        // given
        SearchMusicListRequest request = new SearchMusicListRequest("test query", null);

        // when
        Set<ConstraintViolation<SearchMusicListRequest>> violations = validator.validate(request);
    ...
    void shouldFailValidation_whenQIsNull() {
        // given
        SearchMusicListRequest request = new SearchMusicListRequest(null, null);
