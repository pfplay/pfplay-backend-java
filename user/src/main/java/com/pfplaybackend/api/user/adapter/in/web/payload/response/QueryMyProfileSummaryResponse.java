...
@Data
@Builder
public class QueryMyProfileSummaryResponse {
    ...
    public static QueryMyProfileSummaryResponse from(ProfileSummaryDto profileSummaryDto) {
        return QueryMyProfileSummaryResponse.builder()
